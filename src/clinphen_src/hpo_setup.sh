...
/c/Users/levrex/Anaconda3/envs/my_env/Scripts/ipython3.exe$DIR/hpo_syns.py $DIR/data/hp.obo > $DIR/data/tmp
/c/Users/levrex/Anaconda3/envs/my_env/Scripts/ipython3.exe $DIR/standardize_syn_map.py $DIR/data/tmp > $DIR/data/hpo_synonyms.txt
rm $DIR/data/tmp
/c/Users/levrex/Anaconda3/envs/my_env/Scripts/ipython3.exe $DIR/hpo_names.py $DIR/data/hp.obo > $DIR/data/hpo_term_names.txt 
